  ...
  return (
    <main className="min-h-screen bg-[#0b1326] text-white">
      ...
      <div className="mx-auto max-w-[850px] px-5 py-8">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="relative h-44 w-44">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <span className="mt-2 text-xs uppercase tracking-[4px] text-[#b8c4ff]">
                  SCORE
                </span>
        ...
        <section className="mt-8 flex flex-col gap-4 sm:flex-row">
          ...
          <button
            ...
            className="flex-1 rounded-2xl border border-white/10 bg-white/5 px-6 py-4 text-lg font-semibold transition hover:bg-white/10"
          >
            Retake Quiz
          </button>
        ...
        <section className="mt-8 rounded-3xl border border-white/10 bg-[#171f33]/60 p-8">
      ...
      <footer className="border-t border-white/10 py-8 text-center text-sm text-gray-400">
        ...
        <p>
          Keep learning. Stay prepared. Save lives.
        </p>
