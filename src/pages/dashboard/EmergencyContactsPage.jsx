    ...
    <main className="min-h-screen  text-white">
        ...
        <div className="mx-auto max-w-7xl px-6 py-16">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-5 max-w-2xl text-lg text-slate-300">
              Instantly access verified emergency helplines, hospitals, disaster response teams and
              rescue services whenever you need them.
            </p>
      ...
      <section className="mx-auto mt-12 max-w-7xl px-6">
        <div className="mb-8 flex items-center gap-3">
          ...
          <h2 className="text-3xl font-bold">Emergency Numbers</h2>
        </div>
          ...
          {quickActions.map((item) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-3 text-4xl font-bold text-red-400">{item.number}</p>
          ...
          {helplines.map((item, index) => (
            <div
              ...
              className={`flex items-center justify-between px-8 py-6 ${
                index !== helplines.length - 1 ? "border-b border-white/10" : ""
              }`}
            >
              <div>
              ...
              <div className="flex items-center gap-4">
                <span className="text-3xl font-bold text-red-400">{item.number}</span>
      ...
      <section className="mx-auto mt-20 max-w-7xl px-6">
        <div className="mb-8 flex items-center gap-3">
          ...
          <h2 className="text-3xl font-bold">State & District Emergency Contacts</h2>
        </div>

        <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
          <div className="grid gap-6 md:grid-cols-2">
            <div>
              <label className="mb-3 block font-medium">Select State</label>
            ...
            <div>
              <label className="mb-3 block font-medium">Select District</label>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2">
            <div className="rounded-2xl bg-[#0f1729] p-6">
              <h3 className="font-semibold">District Control Room</h3>

              <p className="mt-3 text-3xl font-bold text-cyan-400">1077</p>
            </div>

            <div className="rounded-2xl bg-[#0f1729] p-6">
              <h3 className="font-semibold">SDRF Office</h3>

              <p className="mt-3 text-3xl font-bold text-cyan-400">+91 755 111111</p>
            </div>

            <div className="rounded-2xl bg-[#0f1729] p-6">
              <h3 className="font-semibold">Collector Office</h3>

              <p className="mt-3 text-3xl font-bold text-cyan-400">+91 755 222222</p>
            </div>

            <div className="rounded-2xl bg-[#0f1729] p-6">
              <h3 className="font-semibold">Emergency Operations Center</h3>

              <p className="mt-3 text-3xl font-bold text-cyan-400">+91 755 333333</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto mt-20 max-w-7xl px-6">
        <div className="mb-8 flex items-center gap-3">
          ...
          <h2 className="text-3xl font-bold">Nearby Emergency Services</h2>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {[
            ...
            >
              ...
              <p className="mt-4 text-2xl font-bold text-emerald-400">{item.distance}</p>
      ...
      <section className="mx-auto mt-20 max-w-7xl px-6">
        <div className="overflow-hidden rounded-[32px] border border-red-500/30 bg-gradient-to-r from-red-500/20 via-red-600/10 to-orange-500/20 p-10">
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="text-4xl font-bold">SOS Emergency</h2>

            <p className="mt-5 max-w-2xl text-lg text-slate-300">
              If you are in immediate danger or witnessing an emergency, contact the National
              Emergency Response Service immediately.
            </p>
      ...
      <section className="mx-auto mt-20 max-w-7xl px-6">
        <div className="mb-8 flex items-center gap-3">
          ...
          <h2 className="text-3xl font-bold">Emergency Tips</h2>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {[
            ...
            >
              ...
              <p className="mt-5 leading-8 text-slate-300">{item.tip}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mx-auto mt-20 max-w-5xl px-6 pb-20">
        <div className="rounded-[32px] border border-indigo-500/20 bg-gradient-to-r from-indigo-500/10 to-cyan-500/10 p-10 text-center">
          <h2 className="text-4xl font-bold">Stay Prepared. Stay Safe.</h2>

          <p className="mx-auto mt-6 max-w-3xl text-lg text-slate-300">
            Save emergency numbers, prepare an emergency kit, and learn disaster response techniques
