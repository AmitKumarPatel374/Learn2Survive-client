...
const ContinueLearning = ({ quiz }) => {
  ...
  if (!quiz) return null
  console.log(quiz)
  const progress = Math.round((quiz.answeredQuestions / quiz.totalQuestions) * 100)

  return (
    <section className="px-6 py-8 lg:px-10">
      <div className="mx-auto max-w-7xl">
        <h2 className="mb-6 text-[32px] font-bold text-white">Continue Learning</h2>
        ...
        <div className="rounded-3xl border border-emerald-500/20 bg-[#171f33]/60 p-6 backdrop-blur-xl">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center">
            ...
            <div className="flex-1">
              ...
              <p className="mt-3 max-w-2xl leading-7 text-[#8e909f]">{quiz.description}</p>
            ...
            <button
              onClick={() => navigate(`/learning/quiz/${quiz.attemptId}`)}
